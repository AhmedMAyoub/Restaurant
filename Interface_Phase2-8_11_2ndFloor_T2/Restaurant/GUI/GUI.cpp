...
void GUI::PrintMessage(string msg) const	//Prints a message on status bar
{
	...
	pWind->DrawString(10, WindHeight - (int) (StatusBarHeight - printedCount), msg); // You may need to change these coordinates later 
	printedCount=printedCount+15;                                                                      // to be able to write multi-line
}

int GUI::printedCount = 0;
...
void GUI::PrintMessage2(string msg) const
{
	...
	pWind->SetPen(DARKRED);
	pWind->SetFont(18, BOLD, BY_NAME, "Arial");
	pWind->DrawString(10, WindHeight - (int)(StatusBarHeight - 0), msg); // You may need to change these coordinates later 
